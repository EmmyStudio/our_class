            ...
            <div className="flex flex-col gap-40 bg-white p-15">
                <div className="flex flex-col border border-white rounded-4xl bg-black gap-10 pd-15">
                    <div className="flex flex-col bg-lightblue border border-white rounded-4xl items-center gap-10 pt-15 pl-15 pr-15">
                        <h1 className="text-7xl max-w-4xl text-black text-center font-bold" id="bigText">
                             Master Ethical Hacking with CEH v13 AI
                        </h1>
                        <div className="flex justify-between gap-20">
                            <div className="flex flex-col gap-5 text-center">
                                <div className="flex flex-col gap-5 border border-darkblue rounded-4xl bg-darkblue p-7 pr-20">
                                ...
                                <div className="flex flex-col gap-5">
                                    <p className="flex justify-center border rounded-3xl bg-orange text-lightblue p-2 max-w-40">AI-Driven Hacking</p>
                                    <p className="flex justify-center border rounded-3xl bg-darkblue text-lightblue p-2 w-40 ml-auto">Threat Defense</p>
                                    <p className="flex justify-center border rounded-3xl bg-orange text-lightblue p-2 max-w-40">Hands-on Labs</p>
                                    <p className="flex justify-center border rounded-3xl bg-darkblue text-lightblue p-2 w-40 ml-auto">v13 AI Curriculum</p>
                                </div>
                            </div>
                            <Image
                                src="/finalia.png"
                            ...
                            <div className="flex flex-col items-center gap-7 ">
                                <h3 className="flex items-center justify-center border border-orange bg-orange w-full aspect-square rounded-full max-w-57 p-10 text-lightblue text-xl font-bold text-center" id="bigText">
                                ...
                                <a
                                    className="flex justify-center items-center border rounded-4xl bg-darkblue p-2 h-15 w-full text-lightblue"
