                    ...
                    <div className="flex flex-col bg-lightblue border border-white rounded-4xl items-center gap-10 pt-15 pl-15 pr-15">
                        ...
                        <div className="flex justify-between gap-20">
                            <div className="flex flex-col gap-5 text-center">
                                <div className="flex flex-col gap-5 border border-darkblue/30 rounded-4xl bg-darkblue p-7 pr-20">
                            ...
                            <div className="flex flex-col items-center gap-7 ">
                                <h3 className="flex items-center justify-center border border-3 border-darkblue/30 bg-orange w-full aspect-square rounded-full max-w-57 p-10 text-lightblue text-xl font-bold text-center" id="bigText">
                                ...
                                <a
                                    className="flex justify-center items-center border rounded-4xl bg-darkblue p-2 h-15 w-full text-lightblue hover:text-white hover:shadow-xl"
