...
export default function ThirD() {
    return (
        <div className="flex flex-col items-center gap-15 bg-darkblue p-20">
            <div className="flex items-center justify-center gap-20 border border-darkblue bg-darkblue shadow-xl rounded-4xl ml-30 mr-30 transition-all duration-300 hover:shadow-2xl hover:shadow-black hover:scale-115">
                <Image
                    src="/woman.png"
                    width={400}
                    height={500}
